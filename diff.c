...
void diff_test2(void) {
	...
	double Babs = sqrt(Bx*Bx + By*By + Bz*Bz);
	double
		gradBx = (Bx*J[0][0] + By*J[1][0] + Bz*J[2][0]) / Babs,
		gradBy = (Bx*J[0][1] + By*J[1][1] + Bz*J[2][1]) / Babs,
		gradBz = (Bx*J[0][2] + By*J[1][2] + Bz*J[2][2]) / Babs;

	double
		curlBx = (Babs*J[2][1] - Bz*gradBy - Babs*J[1][2] + By*gradBz) / (Babs*Babs),
		curlBy = (Babs*J[0][2] - Bx*gradBz - Babs*J[2][0] + Bz*gradBx) / (Babs*Babs),
		curlBz = (Babs*J[1][0] - By*gradBx - Babs*J[0][1] + Bx*gradBy) / (Babs*Babs);
}
