...
TARGET=solver
OBJECTS=arguments.o ctsv.o differentiate.o domain.o equation_predprey.o equation_particle.o input.o interp2.o main.o magnetic_field.o rkf45.o readfile.o vector.o
